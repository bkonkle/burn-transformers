...
use crate::pipelines::sequence_classification::{self, token_classification};
...
impl token_classification::ModelConfig for Config {
    /// Initialize the model
    fn init<B: AutodiffBackend>(&self, device: &B::Device) -> impl token_classification::Model<B>
    where
